  ...
  <ul class="selected-option-list">
    <li>
      <dl>
        ...
        <dd class="option-number">
          ...
          <input type="number" value="4" class="txt-number" title="선택 수량">
    ...
    <li>
      <dl>
        ...
        <dd class="option-gift" aria-label="혜택"><!-- :증정 상품이 아닐 경우 전체 hidden -->
          <span>증정</span>
        </dd>
        <dd class="sale-price" aria-label="판매가격">
          <span class="number-sale-price">
