<template>
  <swiper :options="swiperOption">
      ...
      <div class="slide">
        <div class="slide-item"> <!-- 예약배송일 경우 reserve 클래스 추가 -->
          <a href="#" class="item-link">
            <figure>
              <img src="@/assets/images/_temp/_img_product04_01.jpg" alt="유기농 레몬밤 분말" />
              <!-- 썸네일 없을 경우 -->
    ...
    <div class="slide-item"> <!-- 예약배송일 경우 reserve 클래스 추가 -->
      <a href="#" class="item-link">
        <figure>
          <img src="@/assets/images/_temp/_img_product04_02.jpg" alt="청포도 700g(팩)" />
          <!-- 썸네일 없을 경우 -->
    ...
    <swiper-slide>
      <div class="slide">
        <div class="slide-item"> <!-- 예약배송일 경우 reserve 클래스 추가 -->
          <a href="#" class="item-link">
            <figure>
              <img src="@/assets/images/_temp/_img_product04_03.jpg" alt="유기농 레몬밤 분말" />
              <!-- 썸네일 없을 경우 -->
              <!-- <img src="@/assets/images/img/img_product_nothumb.jpg" title="GSFresh 로고" alt="유기농 레몬밤 분말" /> -->
              <!-- 성인본인인증이 필요한 경우 -->
              <!-- <img src="@/assets/images/img/img_product_identification.jpg" title="성인인증필요" alt="유기농 레몬밤 분말" /> -->
    ...
    <swiper-slide>
      <div class="slide">
        <div class="slide-item"> <!-- 예약배송일 경우 reserve 클래스 추가 -->
          <a href="#" class="item-link">
            <figure>
              <img src="@/assets/images/_temp/_img_product04_01.jpg" alt="양송이버섯 200G(봉)" />
              <!-- 썸네일 없을 경우 -->
