  ...
  <div class="product list product-02">
    <div class="item" :class="{'reserve' : isResvItem(itemValue.resvItemYn)}">
      ...
      <div class="item-thumbnail">
        ...
        >
          <!-- : 품절 상품 시 -->
          <div class="sold-out" v-if="itemValue.ofsYn == 'Y' || itemValue.sellPosbQty == 0 && itemValue.cnslItemYn !== 'Y'">
            <strong>품절</strong>
          </div>
        ...
        <ul class="wrap-product-benefit" title="혜택">
          ...
          <template v-else>
            <li
              v-if="itemValue.nplusYn !== 0 && itemValue.nplusYn > 0 && itemValue.itemCompoCd !== '02' && itemValue.itemCompoCd !== '03'"
      ...
      <div class="wrap-info">
        <dl class="info" title="상품정보">
          <dt>
            ...
            <template v-else-if="cmmSteId == '3'">
              <span class="wrap-delivery-tag">
                <span v-if="itemValue.delivTypeCd == '01'"
                class="delivery-info"
                >당일배송</span>
                <span
                  v-else-if="itemValue.mallId == '302' && retrieveDawnDeliYn"
                  class="delivery-info"
                >새벽배송</span>
                <span
                  v-else
            ...
            <template v-else>
              <span class="wrap-delivery-tag">
                <span v-if="itemValue.delivTypeCd == '01'" class="delivery-info">당일배송</span>
          ...
          <!-- END : 9. 가격정보 (달리살다) -->
          <!-- START : 9. 가격정보 (상담상품) -->
          <template v-else-if="itemValue.cnslItemYn === 'Y'">
            <p class="outside-info">전화 주문/상담만 가능합니다.</p>
          </template>
          <!-- END : 9. 가격정보 (상담상품) -->
        ...
        <button
          ...
          v-if="itemValue.ofsYn == 'N' && itemValue.cnslItemYn !== 'Y' && itemValue.sellPosbQty > 0"
          aria-haspopup="dialog"
        ...
        <button
          v-if="(itemValue.ofsYn == 'Y' || itemValue.sellPosbQty == 0 && itemValue.cnslItemYn !== 'Y') && (itemValue.mallId == '1' || itemValue.mallId == '11' || itemValue.mallId == '20')"
    ...
    <ul
      ...
      title="가치속성태그"
      v-if="daliProduct && itemValue.itemAttrs"
    >
    ...
    <ul class="wrap-product-tag" title="혜택" v-if="cmmSteId !== '3' && !daliProduct && itemValue.itemCompoCd !== '02' && itemValue.itemCompoCd !== '03' && itemValue.cnslItemYn !== 'Y'">
    ...
    <!-- END : 16. 혜택 (GS fresh)  -->
    <!-- START : 17. 해외직구 (달리살다) -->
    <span class="txt-delivery-free" v-if="daliProduct && itemValue.abrdDrctPurchItemYn=='Y' && itemValue.cnslItemYn !== 'Y'">
