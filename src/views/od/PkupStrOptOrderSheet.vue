              ...
              <div class="sub-inner-box">
                <div class="receive-delivery-info">
                  <div class="my-address">
                    <p>GS THE FRESH  강남한티점</p>
                    <button type="button" class="btn-border btn-change-address" aria-label="픽업 매장 팝업 활성화" aria-haspopup="dialog" @click="popupShopAction">변경</button>
                    <p>서울특별시 강남구 선릉로 62길 9</p>
                    <p><span class="ico-tel"><a href="tel:010-1234-5678" title="전화걸기">02-255-0822</a></span><span class="ico-location">위치 보기</span></p>
                  </div>
                </div>
              </div>
            </div>
            <PopupPickupShop @popupEvent="popupAction" v-if="this.popup.popupPickupShop" /> <!-- 팝업 - 픽업 매장 -->
            <!-- END : 픽업센터 -->
            <!-- START : 방문 예정 시간 -->
            <DeliveryTime />
            <!-- END : 방문 예정 시간 -->
