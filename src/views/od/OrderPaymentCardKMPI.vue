<template>
    <div id="payCardKmpiFlag" class="wrap-full-popup" role="dialog" aria-modal="true">
      <div>
...
export default {
  ...
  methods: {
    popupAction() { // 닫기
      this.$emit('popupEvent', 'payCardKmpiFlag');
    },
    async init() {
    ...
    async doPay() {
      ...
      await ApiUtils
        ...
        .then(res => {
          ...
          this.$emit('orderPaymentCallBack', 'payCardKmpiFlag', rsltForm.TID.value, isFail);
        }
      );
    }
  }
