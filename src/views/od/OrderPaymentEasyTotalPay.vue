...
export default {
  ...
  mounted: async function() {
    ...
    window.callbackEasyPayAuth = function(hashKey) {
      ...
      ApiUtils.post("/fo/pa/retrieveEasyPayAuthCallback", data).then(res => {
        ...
        that.resAuthForm.resultMessage = res.data.resultMsg;
    ...
    await ApiUtils
      ...
      .then(res => {
        ...
        // console.log("reqAuthForm : ", reqAuthForm);
      });
  ...
  methods: {
    ...
    async reqAuthEasyPay() {
      ...
      const data = {
        ...
        payType: reqAuthForm.easyPayType,
        paySimpleType: "CARD"
      };
        ...
        Naver.Pay.create({
          ...
          onAuthorize: function(resData) {
              ...
              */
              ...
              resAuthForm.resultMessage = resData.resultMessage;
    ...
    async reqApprEasyPay() {
      ...
      ApiUtils
        ...
        .then(res => {
          ...
          this.$emit('orderPaymentCallBack', 'payEasyTotalPayFlag', this.resAuthForm.tid, isFail);
        });
    },
  }
};
