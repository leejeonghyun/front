<template>
  <div id="optionResvDefault" :class="{'wrap-option-popup': dispType === 'MD', 'wrap-full-popup': dispType !== 'MD'}" role="dialog" aria-modal="true">
...
export default {
  ...
  mounted: async function() {
    ...
    this.resvInfo.dyofDt = this.$props.itemData.dyofDt;
