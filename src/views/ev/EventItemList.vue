...
<template>
    ...
    <!-- <div id="popupApplicableCoupon" class="wrap-layer alert-layer plus-alert-layer active" role="dialog" aria-labelledby="PopupApplicableCoupon" aria-modal="true" :class="{active : this.modalActive.popupApplicableCoupon}"> -->
      <!-- 실사용 소스
       -->
    <div id="popupApplicableCoupon" class="wrap-layer description-layer" role="dialog" aria-labelledby="popupApplicableCoupon" aria-modal="true" :class="[{active : this.modalActive.popupApplicableCoupon}, siteClass]">
      <div class="layer-bg" @click="popupAction"></div>
      <div class="layer-inner coupon">
        <div class="inner-box">
          <div class="title">
            <h3>쿠폰 적용 가능 상품</h3>
          </div>
          <div class="layer-content scroll-area product">
            <!-- START : 상품 목록 -->
            <div class="wrap-product-list">
              <MypageCouponProduct @popupEvent="innerPopupAction" :popup="popup"/>
            </div>
            <!-- END : 상품 목록 -->
          </div>
        </div>
