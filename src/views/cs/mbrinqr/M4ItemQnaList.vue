...
Pg id: PG-FO-CS-O032
Uri: /cs/mbrinqr/m4_item_qna_list
-->
<template>
  <div class="wrap-mypage public_domain qna" v-bind:class="[siteClass]">
    ...
    <main id="main" tabindex="0">
      ...
      <div class="wrap-tab-content" ref="tabContents">
        ...
        <div class="wrap-promotion-filter delivery">
          <div class="btn-filter-layer">
            <SelectUINormal :selectData="selectData" @changeSelectList="changeSelectList"/>
          </div>
        </div>
                  ...
                  <div class="review-inner">
                    ...
                    <div class="list-type01-inner">
                      ...
                      <div class="wrap-title">
                        ...
                        <p class="brand">
                        <span class="brand-imagearea">
                          <img :src="require('@/assets/images/mall_logo/'+dtlQna.mallId+'.png')" alt="로고" class="mall_image" @click="goUrl(dtlQna.mallId)">
                        </span>
                      </p>
                      ...
                      <div class="product-name" v-if="dtlQna.itemNm">
                        ...
                        <a
                          ...
                          @click="goToItemDtl(dtlQna.cmmSteId, dtlQna.itemId, dtlQna.storId, dtlQna.supplFirmCd, dtlQna.mallId)"
                        >
                          <span class="hidden">상품명</span>
                          <span class="link-text">{{ dtlQna.itemNm.replace("[]", "") }}</span>
                        </a>
                      </div>
...
import SelectUINormal from '@/components/common/SelectUINormal';
export default {
  name: 'MyPageInquiry',
  metaInfo: {
  ...
  data() {
    return {
      ...
      period: {
        ...
        start: {
          date: DateUtils.subtract(DateUtils.getToday(), 15, 'day'), // default = 1개월
          day: DateUtils.format(
            DateUtils.subtract(DateUtils.getToday(), 15, 'day'),
            'dd'
          ),
        },
        end: {
      ...
      selectData: {
        selected: 0,
        options: [
          { id: 0, txt: '최신일순', value: '0'},
          { id: 1, txt: '등록일순', value: '1'}
        ]
      },
      active: 0, // 활성
      type: 'all', // 기본 default 조회 타입
      months: ['15일', '1개월', '3개월', '6개월'], // 기간 조회 버튼
      monthCds: ['15D', '1M', '3M', '6M'], // 기간 조회 코드
  ...
  methods: {
    ...
    goToItemDtl(cmmSteId, itemId, storId, supplFirmCd, mallId) {
    ...
    activeMonth(idx) {
      ...
      if (this.active !== idx) {
        ...
        if (this.monthCds[this.active] == '15D') {
          this.period.start.date = DateUtils.subtract(
            DateUtils.getToday(),
            15,
            'day'
          );
        } else if (this.monthCds[this.active] == '1M') {
          this.period.start.date = DateUtils.subtract(
            DateUtils.getToday(),
            1,
            'month'
    ...
    changeSelectList(selectedindex) {
      this.orderBy = selectedindex;
      this.retrievelistMbrInqr();
    }
  },
  mounted() {
