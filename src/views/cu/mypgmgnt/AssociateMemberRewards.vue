<template>
  <div class="wrap-mypage member" v-bind:class="[siteClass]"><!-- 새벽배송 : 20.04.10 몰 컬러 구분이 필요한 경우, 클래스 추가 (GSfresh - gsfresh, 달리살다 - dalisalda, 새벽배송 - daybreak) -->
                ...
                this.genderStr = "M";
                    ...
                    const uesrChk = {
                      ...
                      phoneCorp: res.data.data.phoneCorp
                                                    ...
                                                    console.log(
                                  'uesrChk ' + JSON.stringify(uesrChk)
                                );
        ...
        .then(res => {
          ...
          if (!StringUtils.isEmpty(dvcId)) {
            ...
            if (
              ...
              // 모바일웹 리턴 URL 추가
              localStorage.setItem('reUrl', '/cu/associate_member_rewards');
              subKmc.target = '';
            } else {
              const popupX = CuUtils.popupX('500');
              const popupY = CuUtils.popupY('600');
