...
export default {
  ...
  mounted() {
    ...
    ApiUtils.get('/fo/cu/loginmgnt/sns-login-facebook-response', data, {
    ...
    // http://localhost:7300/cu/snscallback?code=QxmG3kXsWaNbJqsjTR&state=123/
  },
};
</script>
